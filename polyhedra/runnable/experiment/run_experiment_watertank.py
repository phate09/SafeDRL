...
from agents.ppo.tune.tune_train_PPO_watertank import get_PPO_config
from agents.ray_utils import convert_ray_policy_to_sequential
from polyhedra.experiments_nn_analysis import Experiment


class WaterTankExperiment(Experiment):
    def __init__(self):
        ...
        self.n_actions = 2
        self.unsafe_zone: List[Tuple] = [([p], np.array([100])), ([-p], np.array([0]))]  # -0.55
