...
class ORACartpoleExperiment(CartpoleExperiment):
    ...
    def post_milp(self, x, nn, output_flag, t, template):
        ...
        for chosen_action in range(2):
            ...
            if feasible_action:
                x_prime_results = optimise(template, gurobi_model, input)  # h representation
                x_prime = generate_input_region(gurobi_model, template, x_prime_results, self.env_input_size)
