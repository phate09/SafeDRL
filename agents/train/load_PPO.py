...
import ray
from agents.ray_utils import convert_ray_policy_to_sequential, load_sequential_from_ray, get_pendulum_ppo_agent
...
sequential_nn = load_sequential_from_ray("/home/edoardo/ray_results/PPO_PendulumEnv_2020-09-18_11-23-17wpwqe3zd/checkpoint_25/checkpoint-25")
for i in range(1000):
