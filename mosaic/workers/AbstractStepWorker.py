...
class AbstractStepWorker:
    ...
    def work(self, intervals: List[Tuple[Tuple[Tuple[float, float]], bool]]) -> Tuple[
        List[Tuple[Tuple[Tuple[Tuple[float, float]], bool], List[Tuple[Tuple[float, float]]]]], List[Tuple[Tuple[Tuple[Tuple[float, float]], bool], List[Tuple[Tuple[float, float]]]]]]:
        ...
        return successors_list, terminals_list
